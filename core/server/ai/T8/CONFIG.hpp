...
T8U_var_DirectCallRange			= 150;			// group leader searches for help within XXX m
...
T8U_var_CallForHelpTimeout		= 120;			// a group can only call one other group each x sec for help
