...
T8U_var_DirectCallRange			= 50;			// group leader searches for help within XXX m
T8U_var_RevealRange				= 50;			// group leader shares info of enemies he "knowsabout > 1" to friendly units within XXX m
...
T8U_var_CallForHelpTimeout		= 150;			// a group can only call one other group each x sec for help
